<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\wamp64\www\tp5\public/../application/admin\view\login\login.html";i:1531975753;}*/ ?>
<!DOCTYPE html>
        ...
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-submit">
                    ...
                    <img src="<?php echo captcha_src(); ?>" alt="captcha" style="float: left; cursor: pointer;" onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();">
                </div>
                <div class="loginbox-submit">
